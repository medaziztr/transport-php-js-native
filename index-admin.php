                    ...
                    <div class='tab-content'>
                        <div role='tabpanel' class='tab-pane fade in active' id='abonnement'>
                            ...
                            `
                                ...
                                <option value = '1 year' $ {
                                    ( row.date_fin == <?php echo date( 'd/m/Y', strtotime( '1 year' ) ) ;
                                    ?> )?'selected':''}
                                    >
                                    Pack 1 Ans</option>
                                    <option value = '6 months' $ {
                                        ( row.date_fin == <?php echo date( 'd/m/Y', strtotime( '6 months' ) ) ;
                                        ?> )?'selected':''}
                                        >
                                        Pack 6 Mois</option>
                                        <option value = '3 months' $ {
                                            ( row.date_fin == <?php echo date( 'd/m/Y', strtotime( '3 months' ) ) ;
                                            ?> )?'selected':''}
                                            >
                                            Pack 3 Mois</option>
                                            </select>
...
`
                ...
                <input type="submit" value="Consulter"
                                                            onclick="location.href='chargement.php?id_charg = $ {
                row.id_charg}
                ' ">
