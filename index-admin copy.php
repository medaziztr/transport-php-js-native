                                            ...
                                            <div class="contact-map">
                                             ...
                                             ?>
                                                <div class="container result-rech">
                                                    ...
                                                    <div class="res-flx hidden-xs"><?php echo $r['marchandise']; ?>
                                                    </div>
                                                    <div class="res-flx">Depart :
                                                        <?php echo $r['ville_charg'].' ,'.$r['pays_charg']; ?></div>
                                                    <div class="res-flx">Arrivée :
                                                        <?php echo $r['ville_liv'].', '. $r['pays_liv']; ?></div>
                                                    <div class="res-flx petit"><?php echo $r['poid'].' Tonnes'; ?></div>

                                                    <div class="res-flx petit hidden-xs">
                                                        <input type="submit" value="Consulter"
                                                            onclick="location.href='chargement.php?id_charg=<?php echo $r['id_charg']; ?>' ">
                                                    </div>
                                                    ...
                                                    <a onclick="return confirm('Êtes-vous sûr de votre choix ?')"
                                                        class="supp"
                                                        href="supp-charg.php?id_charg=<?php echo $r['id_charg']; ?>"><img
                                                            src="./img/supp.png"></a>
                                            ...
                                            <div class="contact-map">
                                             ...
                                             ?>
                                                ...
                                                <div class="container result-rech">
                                                    ...
                                                    <div class="res-flx hidden-md hidden-sm hidden-lg">
                                                        <?php echo $r['nom']; ?></div>
                                                    ...
                                                    <div class="res-flx petit"><?php echo $r['poid_disp']; ?> Tonnes
                                                    </div>
                                                    <div class="res-flx hidden-xs petit act"><span
                                                            class="flaticon-international "></span></div>
                                                    <div class="res-flx petit hidden-xs">
                                                        <input type="submit" value="Consultez"
                                                            onclick="location.href='disponibilite.php?id_disp=<?php echo $r['id_disp']; ?>'  ">
                                                    </div>
                                                    ...
                                                    <a onclick="return confirm('Êtes-vous sûr de votre choix ?')"
                                                        class="supp"
                                                        href="supp-disp.php?id_disp=<?php echo $r['id_disp']; ?>"><img
                                                            src="./img/supp.png"></a>
                                                </div>
