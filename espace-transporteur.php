                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5 col-xs-12 no-padding">
                                                                <select class="form-control" id="" name="id_ab"
                                                                    required>
                                                                    <?php
                                                                            do{
                                                                        ...
                                                                        ?>
                                                                    <option
                                                                        value="<?php echo $res['id_abonnement']; ?>">
                                                        ...
                                                        <a href="#" id='logintest' data-toggle="modal"
                                                            data-target="#login">Vous n'êtes pas connecté</a>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-5 col-xs-12 no-padding">
                                                                    <input type="text" id="contact_name"
                                                                        name="contact_name" value="" class="col-xs-12">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-3 col-xs-12  no-padding left-title">
